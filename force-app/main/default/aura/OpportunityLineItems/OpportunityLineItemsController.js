({
  ...
  doInit: function (component, event, helper) {
    ...
    action3.setCallback(this, function (response) {
      if (response.getReturnValue() === "Needs Analysis") {
      ...
      if (response.getReturnValue() === "Presentation") {
    ...
    action.setCallback(this, function (response) {
      ...
      console.log(component.get("v.RelatedOpportunityLineItems"));
    });
    $A.enqueueAction(action);

    var action2 = component.get("c.getCountOfOpportunityLineItems");
    action2.setParams({
      recid: component.get("v.recordId")
    });
  ...
  gotoRelatedList: function (component, event, helper) {
    var newEvent = $A.get("e.force:navigateToComponent");
    newEvent.setParams({
      componentDef: "c:OpportunityLineItems",
      navigate: "true",
      componentAttributes: {
        recordId: component.get("v.recordId"),
        viewAll: "false",
